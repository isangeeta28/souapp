...
class SavingTypeScreen extends StatelessWidget {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          ListTile(
                            leading: Image.asset('assets/images/bx-radio-circle-marked 1.png'),
                            title: Text('Random Cycle',
                            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.black),),
                            subtitle: Text(' save any amount you want  daily',
                                style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.backgroundblue))
                          ),
