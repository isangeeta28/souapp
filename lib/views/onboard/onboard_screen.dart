            ...
            itemBuilder: (context, index){
              ...
              return Stack(
                children: [
                  ...
                  if (currentIndex == slides.length - 1) Positioned(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: const Text(AppStrings.signup,
                                    style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14, color: AppColors.white),),
                                ),
                              ),
                            ),
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: const Text(AppStrings.signin,
                                      style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14, color: AppColors.fadegrey)),
                                ),
                              ),
                            ),
                          ],
                      ...
                      child:  SizedBox(
                        child: GestureDetector(
                          ...
                          child: Text(AppStrings.skip,
                            style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: AppColors.white),),
                        ),
                      ))
                ],
              );
